	...
	else
	{
      ...
      cerr << "Can't find parameters file " << endl;
		...
		for ( int i = 0 ; i < m_nLightObjectNumber; i++){
			/* Get X position */
			m_pcvLightObjects[i].x = (rand()%100)*(2.4)/100.0 - 1.2;
			/* Get Y Position */
			m_pcvLightObjects[i].y = (rand()%100)*(2.4)/100.0 - 1.2;
			printf("Light: %d; X: %f; Y: %f\n", i, m_pcvLightObjects[i].x, m_pcvLightObjects[i].y);
		}
		...
		for ( int i = 0 ; i < m_nBlueLightObjectNumber; i++){
			/* Get X position */
			m_pcvBlueLightObjects[i].x = (rand()%100)*(2.4)/100.0 - 1.2;
			/* Get Y Position */
			m_pcvBlueLightObjects[i].y = (rand()%100)*(2.4)/100.0 - 1.2;
			printf("BlueLight: %d; X: %f; Y: %f\n", i, m_pcvBlueLightObjects[i].x, m_pcvBlueLightObjects[i].y);
		}
